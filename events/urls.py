...
from events.views import organizer_dashboard, user_dashboard, create_event, update_event, delete_event, events_by_category, event_detail, show_events, rsvp_event
